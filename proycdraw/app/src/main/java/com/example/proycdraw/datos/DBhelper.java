package com.example.proycdraw.datos;
...
public class DBhelper extends SQLiteOpenHelper {
    ...
    // Metodos Propios....
    public void insertData(String campo1, String campo2, String campo3, byte[] image,
                           String table){
    ...
    public void updateProductoById(String table,String id,String campo1, String campo2,
                                   String campo3, byte[] image){
